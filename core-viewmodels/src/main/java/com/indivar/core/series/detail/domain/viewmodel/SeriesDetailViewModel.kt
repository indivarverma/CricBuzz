...
class SeriesDetailViewModel @Inject constructor(
    ...
    override fun mapState(dataState: DataState): SeriesDetailViewState = SeriesDetailViewState(
        title = dataState.seriesGroup?.type ?: "",
        list = dataState.seriesGroup?.series.orEmpty(),
