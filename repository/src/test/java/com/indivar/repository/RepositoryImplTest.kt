...
class RepositoryImplTest {
    ...
    fun `verify Match object is pulled correctly`() {
        runTest {
            ...
            Assert.assertTrue(match is Response.Success)
            val success = match as Response.Success
            Assert.assertEquals(success.data.id, matchDetail.results?.fixture?.id)
            Assert.assertEquals(success.data.seriesId, matchDetail.results?.fixture?.series_id)
